...
// REMOVER BARRAS DE ROLAGEM
  $("#EnviarCadastroDepartamento").click(function(){
    $("html, body").css({
...
<div class"container">
    ...
    <div class="row">
        ...
        <div class="col-md-2">
          ...
          <div class="input-group">
              <input class="form-control" type="number" id="CodDep" name="CodDep" placeholder="Código" />
    ...
    <div class="row">
        <div class="col-md-6">
              <label for="NomDep">* Nome Departamento / Seção  </label>
              <input class="form-control" type="text" id="NomDep" name="NomDep" placeholder="Nome Departamento / Seção" required/>
        </div>
  </div>
