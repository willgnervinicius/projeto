...
// REMOVER BARRAS DE ROLAGEM
  $("#EnviarCadastroSubGrupo").click(function(){
    $("html, body").css({
...
function LimparFormulario(){
  $('#EnviarCadastroSubGrupo').each (function(){
      this.reset();
    });
...
function salvar(){
	//var data = {}
                var json = ConvertFormToJSON("#EnviarCadastroSubGrupo");
                var Form = this;
 $('#myModal').modal('show');
	$.ajax({
...
<form class="form"  id="EnviarCadastroSubGrupo" method="post"  action="">
...
<div class"container">
    <div class="row">
        ...
        <div class="col-md-2">
          ...
          <div class="input-group">
              <input class="form-control" type="number" id="CodSub" name="CodSub" placeholder="Código" />
  ...
  <div class="row">
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select class="form-control" data-size="5" data-live-search="true" data-width="100%" id="CodGru" name="CodGru" >
               ...
               @if(isset($listaGrupo))
               @foreach($listaGrupo as $dadosgrupo)
                        <option value="{{$dadosgrupo -> CodGru}}"> {{$dadosgrupo -> NomGru}} </option>
              @endforeach
              @endif
            </select>
         </div>
    ...
    <div class="row">
        <div class="col-md-6">
              <label for="NomSub">* Nome SubGrupo  </label>
              <input class="form-control" type="text" id="NomSub" name="NomSub" placeholder="Nome SubGrupo" required/>
        </div>
  </div>
    ...
    <div class="row">
      <div class="col-md-2">
        <div class="form-group">
            <label for="SitSub">Situação</label>
            <select class="form-control" data-size="5" data-live-search="true" data-width="100%" id="SitSub" name="SitSub" >
